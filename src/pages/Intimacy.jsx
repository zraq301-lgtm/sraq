...
import { 
  ...
  Activity, BookOpen, Hand, ChevronRight, X, PenTool, Save
} from 'lucide-react';
...
const INTIMACY_CATEGORIES = [
  ...
  { id: 10, title: 'الاطمئنان الروحي', icon: <Hand className="text-blue-500"/>, items: ['الدعاء قبل العلاقة 🤲', 'الغسل المشترك 🚿', 'شكر الله على السكن 🛐', 'نية الإعفاف والاحتساب 💎', 'الاستغفار 📿', 'قراءة القرآن في البيت 📖', 'قيام الليل معاً 🌌', 'الذكر الدائم 🕊️', 'الإحسان للطرف الآخر 🌟', 'بناء بيت مسلم 🏡', 'التوكل على الله 🎯', 'الرضا بالنصيب ✅', 'البركة في الذرية 🐣', 'حب الله ورسوله ❤️', 'الوفاء بالعهود 📜'] }
];
...
const RaqqaHarmonyApp = () => {
  ...
  const [secretDiary, setSecretDiary] = useState("");
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-md p-8 rounded-[40px] border-2 border-dashed border-red-200 shadow-sm relative overflow-hidden group">
               ...
               <textarea 
                  ...
                  placeholder="دوني هنا مشاعركِ الخاصة، لحظاتكما الجميلة، أو ما يقلقكِ بصراحة تامة..."
               />
